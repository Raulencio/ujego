...
var esesi="img/practica.png";
var dirPract="img/practica.png";
...
var yohiro="img/yohirostand.png";  
var yohiroAtacandoA;
var yohiroAtacandoB;
...
var espadaFuego=false,espadaB="Espada de Fuego",iespadaB="img/espadaFuego.png",pespadaB=2000;
var espadaHielo=false,espadaA="Espada de Hielo",iespadaA="img/espadaHielo.png",pespadaA=1500;
var kataFilosa=false,espadaC="Katana Filosa",iespadaC="img/espadaOtra.png",pespadaC=3000;
var kataBosque=false,espadaD="Katana del Bosque",iespadaD="img/espadaPasto.png",pespadaD=5000;
...
var exptotal=0;
var cuantaexp=500;
function dif(n){todolasArmas();playTres=true;cuantaexp=500;ataqueCarma=0;ataque=0;
    ...
    if(n==1){ 
        ...
        yohiroAtacandoA="img/ko.png";
        yohiroAtacandoB="img/ko.png";
        yohiroCorriendoA="img/ko.png";
        yohiroCorriendoB="img/ko.png";
        yohiroCaminando="img/ko.png";
        yohiroArriba="img/ko.png";
        yohiroAbajo="img/ko.png";
        yohiroEspA="img/ko.png";
        yohiroEspB="img/ko.png";
        yohiroEspC="img/ko.png";
        yohiroEspD="img/ko.png";
        espadaHieloMano="img/ko.png";
        espadaFuegoMano="img/ko.png";
        espadaKatFiMano="img/ko.png";
        espadaBoskeMano="img/ko.png";
        espadaHachaMano="img/ko.png"
        bloqueandoimg="img/ko.png";
        yohiroDesefunde="img/ko.png";
        velorecup=10000;             
    }
    if(n==2){  
...
var cSol=["Sol","Bendecida con un poder sin igual, Sol madre de las estrellas, hija del universo","","img/sol.png"];
...
dir=n;dirc=n;    
    ...
    if((mLeft<1000&&mLeft!=0&&mPLeft<espacioA)&&(!armaFuera)){ 
        ubic-=velocidad;          
        mLeft+=velocidad;
        mMleft+=velocidad; 
...
//poner imagen mirando derecha
    ...
    if((mLeft<1000&&mLeft!=largomapaB&&mPLeft>=espacioB)&&(!armaFuera)){
        document.getElementById("iTiendaMapa").style.marginLeft=mLeftTienda+"px";
        mLeft-=velocidad;
        mMleft-=velocidad;  
        mLeftTienda-=velocidad;  
